...
private:
    ...
    void refreshPendingHighlightState();
    ...
    bool tapCountPending_ = false;
    bool lowCorrectionPending_ = false;
    bool highCorrectionPending_ = false;
    bool maxBoostPending_ = false;
    bool maxCutPending_ = false;
    bool smoothnessPending_ = false;
    bool mixedPhaseMaxPending_ = false;
